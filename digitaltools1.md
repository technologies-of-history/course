...
3. You'll see a single file in there titled **2025-12-07-welcome-to-technologies-of-history.md**. This is the Markdown file for the blog post that appears on the homepage of our course website. 
...
- `layout: post` tells the Jekyll developer to use the **post.html** template to style the Markdown that follows. Other **.md files** that you see in the **spring-2026** repository, but not in the **_posts** folder, are set to `layout: page`, which tells the Jekyll site builder to use the **page.html** template for styling the Markdown.
...
4. You'll now see a gray box at the top that shows you the **base** repository you'll be sending your changes to [**technologies-of-history/spring-2026**] and the **head** branch you want to **compare** [**yourusername/spring-2026**].
